...
public abstract class ActivityMainBinding extends ViewDataBinding {
  ...
  @Bindable
  protected MainActivityActivity mActivity;

  @Bindable
  protected HomeViewModel mViewModel;

  protected ActivityMainBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ConstraintLayout lyParent, FragmentContainerView navHostFragment, View view) {
  ...
  public abstract void setActivity(@Nullable MainActivityActivity activity);

  @Nullable
  public MainActivityActivity getActivity() {
    return mActivity;
  }
