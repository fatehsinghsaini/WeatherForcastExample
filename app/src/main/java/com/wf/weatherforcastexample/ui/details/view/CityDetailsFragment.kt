...
import com.wf.weatherforcastexample.core.utils.setBindImage
import com.wf.weatherforcastexample.core.utils.setBindString
import com.wf.weatherforcastexample.core.utils.setBindTemp
...
class CityDetailsFragment (override val layoutResourceLayout: Int = R.layout.fragment_city_details) : BaseFragment<FragmentCityDetailsBinding>() {
    ...
    private fun insertData(data: ForecastCityResponse) {
        ...
        data.list?.forEach { item ->
            forecastRows.add(
                ForecastRow(main = item.weather?.first()?.main,
